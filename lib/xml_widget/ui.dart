...
class MayaXmlWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => MayaXmlWidgetState()..onUnkown = onUnkownElement;
...
/// by the id string.
///
class MayaXmlWidgetState extends State<MayaXmlWidget> with NodeControl {
  Template? template;
  late Status status;
  ...
  @override
  void didUpdateWidget(MayaXmlWidget oldWidget) {
