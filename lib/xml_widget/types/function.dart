...
Register register = Register(() {
  MayaXmlWidget.register("Function", (node, key) {
  ...
  MayaXmlWidget.register("Call", (node, key) {
    var call = Call(
  ...
  MayaXmlWidget.register("Builder", (node, key) {
    var builder = Builder(
      node,
    );
  ...
  MayaXmlWidget.register("SetArgument", (node, key) {
    var set = SetArgument(
        ret: node.s<String>("return"),
  ...
  MayaXmlWidget.register("Script", (node, key) {
    var script = Script(node.raw);
    script.execute(node.status);
    return script;
  });
  MayaXmlWidget.register("Argument", (node, key) {
